...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/cmddroid/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/cmddroid/wall.png"
...
theme.weather = lain.widget.weather({
    city_id = 2829701, -- placeholder (London)
    settings = function()
		lang = "ger"
